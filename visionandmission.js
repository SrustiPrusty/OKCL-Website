...
function openVISION() {
    ...
    contentt2.style.transform = "translateX(100%)"

    btnn1.style.color = "#ff7846"
    btnn2.style.color = "#001D45"
  
    contentt1.style.transitionDelay = "0.3s";
    contentt2.style.transitionDelay = "0s";
}
  
function openMISSION() {
    contentt1.style.transform = "translateX(100%)"
    ...
    contentt2.style.transitionDelay = "0.3s";
